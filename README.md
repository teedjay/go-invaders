...
## Implementation
All code has been created using Codex (GPT5.2, Medium from the the MacApp,
Versoon 260206.1448 (565)).  I used planning mode for new features and the
whole game was made during an evening.
